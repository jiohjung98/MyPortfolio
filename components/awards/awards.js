    ...
    return (
        <section className='flex-row'>
            <section className="container mx-auto flex-row md:flex-row flex-col items-center">
                ...
                <img className='mb-20 mt-10 ml-5' src='/Software-up-8.png' alt='software-up 8' width="300" height="500" />
            </section>
            ...
            <section className="container mx-auto flex-row md:flex-row flex-col items-center">
                ...
                <img className='mb-20 mt-10 ml-5' src='/Software-up-10.png' alt='software-up 10' width="300" height="500" />
            </section>
            <hr className="w-10/12 mx-auto my-10 border-gray-300"/> 
            <section className="container mx-auto flex-row md:flex-row flex-col items-center">
                ...
                <img className='mb-20 mt-10 ml-5' src='/makerton-5.png' alt='makerton 5' width="300" height="500" />
            </section>
        </section>
    )
};